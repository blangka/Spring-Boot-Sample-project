...
public class OrderRepositoryOld {
    ...
    public List<Order> findAllByString(OrderSearch orderSearch) { //동적 쿼리 해결 예제
        ...
        /* to be 굉장히 힘들다. 이게 JPA를 안쓰는 대표적인 이유이다. 이건 쿼리 DSQL 로 추후에 해보자*/
    ...
    /**
     * JPA Criteria 그나마 나은 동적 쿼리 JPQL 하지만 권장하지 않는 방법이다. 실무에서 사용 X
     */
    ...
    /**
     * distinct는 DB에 distinct 를 날리고 같은 id면 중복을 제거해줌
     */
